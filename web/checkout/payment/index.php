          ...
          <div class="row">
            <table class="table table-striped">
              ...
              <tr align="right">
                ...
                <td>
                  <span class="cart-price">Rs.<?php echo FinalCartAmount(); ?></span>
                </td>
              </tr>
            </table>
          </div>
              ...
              <form action="../../../controller/ordercontroller.php" method="POST">
                ...
                <div class="row text-center">
                  ...
                  <div class="col-md-12">
                    ...
                    <button class="btn btn-lg btn-success" onclick="CheckMode()" name="CreateOrder">Continue & Placed Order <i class="fa fa-angle-double-right text-white"></i></button>
                  </div>
                </div>
              </form>
            </div>
