...
if (isset($_POST['AddItemsToCart'])) {
 ...
 $CartItemDescriptions = $_POST['CartItemDescriptions'];
 ...
 if ($PaymentMode == "Cash On Delivery") {
  ...
  foreach ($CartItems as $Items) {
   ...
   $SaveItems = SAVE("ordered_products", ["ProductRefernceCodes", "OrderDetails", "OrderOrderId", "OrderProProductId", "OrderProductName", "OrderProductImage", "OrderProductCatName", "OrderProductSubCatName", "OrderProductBrandName", "OrderProductSellPrice", "OrderProductMrpPrice", "OrderProductQty", "OrderProductSellAmount", "OrderProductWeight", "OrderProductDescription"]);
  }
