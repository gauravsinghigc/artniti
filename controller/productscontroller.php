...
if (isset($_POST['CreateProductCategories'])) {
 ...
 if ($SaveProducts == true) {
  ...
  $access_url = ADMIN_URL . "/products/upload-img.php?id=" . SECURE($ProductId, "e");
 } else {
 ...
 $AddOptionValues = SAVE("pro_options", ["ProOptionCategoryId", "ProOptionProductId", "ProOptionName", "ProOptionValue", "ProOptionCharges"]);
 RESPONSE($AddOptionValues, "Option Value Added Successfully!", "Unable to Add Option Value");
 ...
 $UpdateOptionValues = UPDATE_TABLE("pro_options", ["ProOptionCategoryId", "ProOptionName", "ProOptionValue", "ProOptionCharges"], "ProOptionsId='$ProOptionId'");
